...
```{r task2, echo=TRUE, fig.align='center'}
...
```{r task3, echo=TRUE, fig.align='center'}
...
```{r task4, echo=TRUE, fig.align='center'}
...
```{r task5, echo=TRUE, message=FALSE, fig.align='center', fig.width=10}
